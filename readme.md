...
This process invovles creating a new user account on Q Support - if you already have a Q Support user account and are using the same email - you will be "re-connected" to this account.
