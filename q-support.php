...
/**
 * Plugin Name:     Q Support
 * Plugin URI:      http://wp-support.co/
 * Description:     Q Support helps website administrators, developers and owners to solve technical issues and configuration problems with WordPress themes, widgets & plugins.
 * Version:         1.2.0
 * Author:          Q Studio
...
if ( ! class_exists( 'Q_Support' ) ) 
{
    ...
    // plugin version
    define( 'Q_SUPPORT_VERSION', '1.2.0' ); // version ##
    ...
    // for links out ##
    define( 'Q_SUPPORT_DOMAIN', 'https://qstudio.us/' );
