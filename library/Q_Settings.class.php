    ...
    class Q_Settings
    {
        ...
        *--------------------------------------------*/
            ...
            return array (
                ...
                ,'agent'           => array(
                    ...
                    ,'desc'         => sprintf( 
                                        ...
                                        , esc_url( Q_SUPPORT_DOMAIN.'releases/q-support/#dedicated-agents' )
                ...
                ,'wordperss'        => array(
                    ...
                    ,'desc'         => sprintf( 
                                        ...
                                        , esc_url( Q_SUPPORT_DOMAIN.'releases/q-support/#wordpress-data' )
                ...
                ,'server'           => array(
                    ...
                    ,'desc'         => sprintf( 
                                        __( 'Include information about your <a href="%s" class="_blank">%s</a>.', Q_Support::$text_domain )
                                        , esc_url( Q_SUPPORT_DOMAIN.'releases/q-support/#web-server-data' )
                ...
                ,'client'           => array(
                    ...
                    ,'desc'         => sprintf( 
                                        __( 'Include information about your <a href="%s" class="_blank">%s</a>.', Q_Support::$text_domain )
                                        , esc_url( Q_SUPPORT_DOMAIN.'releases/q-support/#client-data' )
        ...
        public function view_settings() 
        {
            ...
            echo '<h2>'; _e( 'Q Support Settings', Q_Support::$text_domain ); echo '</h2>';
            ...
            printf( 
                ...
                ,esc_url( Q_SUPPORT_DOMAIN.'releases/q-support/#community-support' )
                ,esc_html( __("Community", Q_Support::$text_domain ) ) 
                ,esc_url( Q_SUPPORT_DOMAIN.'releases/q-support/#dedicated-agent' )
                ,esc_html( __("Dedicated Agent", Q_Support::$text_domain ) ) 
                ,esc_url( Q_SUPPORT_DOMAIN.'releases/q-support/#support-process' )
...
<?php
        ...
        /**
         * Connect user to qstudio.us/support
         * 
         * @since       0.3
         * 
         * @return      mixed     HTML message on success or False if errors encountered ##
         ...
         * 
         * @since       0.3
         * @return      Array   Containing Q Support Plugin settings for use inside WP
         */
        ...
        /**
         * Helper function to check if User is connected to the Q Support forum
         * 
         * @since       0.3
         * @return      boolean   
         */
