...
(function($) {
    ...
    $("tr.type-q_support").each(function() {
        ...
        // accepted answers ? ##
        if ( $(this).find("td.answers span").hasClass("accepted") ) {
            
            $(this).find("td.post-title strong").wrapInner("<span class='q_support_icons tick wide' title='Accepted Answer'></span>");
